...
enum custom_keycodes{
  ...
  SEND_71, SEND_72, SEND_73, SEND_74, SEND_75, SEND_76, SEND_77, SEND_78, SEND_79, SEND_80,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case SEND_69: if (record->event.pressed) SEND_STRING("69 "); break;
    case SEND_70: if (record->event.pressed) SEND_STRING("70 "); break;
    case SEND_71: if (record->event.pressed) SEND_STRING("71 "); break;
    case SEND_72: if (record->event.pressed) SEND_STRING("72 "); break;
    case SEND_73: if (record->event.pressed) SEND_STRING("73 "); break;
    case SEND_74: if (record->event.pressed) SEND_STRING("74 "); break;
    case SEND_75: if (record->event.pressed) SEND_STRING("75 "); break;
    case SEND_76: if (record->event.pressed) SEND_STRING("76 "); break;
    case SEND_77: if (record->event.pressed) SEND_STRING("77 "); break;
    case SEND_78: if (record->event.pressed) SEND_STRING("78 "); break;
    case SEND_79: if (record->event.pressed) SEND_STRING("79 "); break;
    case SEND_80: if (record->event.pressed) SEND_STRING("80 "); break;
    case SEND_81: if (record->event.pressed) SEND_STRING("81 "); break;
    case SEND_82: if (record->event.pressed) SEND_STRING("82 "); break;
    case SEND_83: if (record->event.pressed) SEND_STRING("83 "); break;
    case SEND_84: if (record->event.pressed) SEND_STRING("84 "); break;
  }
  return true;
}
